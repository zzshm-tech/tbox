...
extern rt_size_t at24cxx_page_read(rt_device_t dev, rt_off_t ReadAddr, void *pBuffer, rt_size_t NumToRead);
extern rt_size_t at24cxx_page_write(rt_device_t dev, rt_off_t WriteAddr, const void *pBuffer, rt_size_t NumToWrite);
#endif
