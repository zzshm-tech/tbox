...
rt_err_t rt_hw_adc_register(struct rt_adc_device	*adc_device,
														const char		*name,
														...
														void 			*data)
{
	...
	adc_device->parent.type 	= RT_Device_Class_Char; /* fixme: should be adc type */
	adc_device->parent.rx_indicate  = RT_NULL;
	adc_device->parent.tx_complete  = RT_NULL;
	adc_device->parent.init 	= ops->rt_adc_init;
	adc_device->parent.write 	= RT_NULL;
	adc_device->parent.control 	= ops->rt_adc_control;
	adc_device->parent.user_data	= data;
	/* register a character device */
	return rt_device_register(&adc_device->parent, name, RT_DEVICE_FLAG_RDWR);
}
