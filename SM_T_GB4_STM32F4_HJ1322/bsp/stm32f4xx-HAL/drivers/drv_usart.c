...
void HAL_UART_MspDeInit(UART_HandleTypeDef *uartHandle)
{
    ...
    if (uartHandle->Instance == USART1)
    {
        ...
        __HAL_RCC_USART1_CLK_DISABLE();      //关闭串口
        /**USART1 GPIO Configuration
        PA9     ------> USART1_TX
        PA10     ------> USART1_RX
        */
        HAL_GPIO_DeInit(GPIOA, GPIO_PIN_9 | GPIO_PIN_10);
				...
				rt_pin_mode(68,PIN_MODE_INPUT);        /** MAX232_T1IN **/
				rt_pin_mode(69,PIN_MODE_INPUT);        /** MAX232_R1OUT **/
    }
#endif /* BSP_USING_UART1 */
#ifdef BSP_USING_UART2    
    if (uartHandle->Instance == USART2)
    ...
    if (uartHandle->Instance == USART3)
    {
        ...
        */
        HAL_GPIO_DeInit(GPIOD, GPIO_PIN_8 | GPIO_PIN_9);
				...
				rt_pin_mode(55,PIN_MODE_INPUT);        /** GPS_RX **/
				rt_pin_mode(56,PIN_MODE_INPUT);		        /** GPS_TX **/
//			
//			GPIO_InitStruct.Pin = GPIO_PIN_8 | GPIO_PIN_9;
...
//      HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);
    ...
    if (uartHandle->Instance == UART4)
    {
      ...
      HAL_GPIO_DeInit(GPIOA, GPIO_PIN_0 | GPIO_PIN_1);
			rt_pin_mode(23,PIN_MODE_INPUT);        /** L718_RX **/
			rt_pin_mode(24,PIN_MODE_INPUT);        /** L718_TX **/
    }		
#endif
...
int hw_usart_init(void)
{
    ...
    rt_hw_serial_register(&serial2, "uart2",
                          ...
                          uart);
#endif /* BSP_USING_UART2 */
#ifdef BSP_USING_UART3              /*UART3用作N303定位模块消息接收*/
		config.baud_rate = BAUD_RATE_9600; /* 115200 bits/s */ 
		config.bufsz = 1024;
    uart = &uart3;
...
#ifdef BSP_USING_UART6                      //UART6，连接蓝牙模块
		config.bufsz = 1024;
    uart = &uart6;
